...
function Calculadora() {
  ...
  function adicionarNumero(numero){
    //let é uma varaival no escopo da função
    let resultado;
    if (operacao === null){
  ...
  function definirOperacao(op){
    //apenas define a operação caso na~exista
    if (operacao === null){
      setOperacao(op);
      return;

    }
    //caso a operação estiver definida e numero2 selecionado, realiza o caculo da operação
    if (numero2 !== null){
